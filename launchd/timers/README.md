...
| landing-highlights | `*-*-* 18:35:00 Asia/Seoul` (+`RandomizedDelaySec=60`) | ~09:35 UTC | **18:35** | Hour 18 / Minute 35 | `35 18 * * *` |
...
landing-highlights   well-formed  sci={'Hour': 18, 'Minute': 35}
