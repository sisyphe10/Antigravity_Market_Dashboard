...
ytd_base_dates = {
    ...
    '개방형 랩': '2025-12-30',
    # '목표전환형 2호': '2026-04-29',  # 2호 완료 (2026-05-06 목표달성, +7.26%)
    # '목표전환형 3차': '2026-04-30',  # 3차 완료 (2026-05-06 목표달성, +7.97%)
    # '목표전환형': '2026-02-11',  # 1차 완료 (6% 목표달성, 2026-02-25 청산)
    # '목표전환형 2차': '2026-03-16',  # 2차 완료 (2026-04-15 목표달성)
    # '목표전환형 1호': '2026-03-25',  # 완료 (2026-04-15 목표달성)
    'KOSPI': '2025-12-30',
    'KOSDAQ': '2025-12-30',
}
