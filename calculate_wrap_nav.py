...
#   시작 기준가: 1,000.00 / 청산 기준가: ~1,079.98 (YTD +8.0%)
#   목표수익률 6% 달성으로 청산. 2026-03-16 2차 설정 예정.
# [2차 DB 목표전환형] 2026-03-16 ~ 2026-04-15
#   시작 기준가: 1,000.00 / 목표수익률 달성으로 청산.
# [NH 목표전환형 1호] 2026-03-25 ~ 2026-04-15
#   시작 기준가: 1,000.00 / 목표수익률 달성으로 청산.
# [DB 목표전환형 3차] 2026-04-30 ~ 2026-05-06
#   시작 기준가: 1,000.00 / 청산 기준가: 1,079.70 (+7.97%, 목표 6% 초과 달성)
# [NH 목표전환형 2호] 2026-04-29 ~ 2026-05-06
#   시작 기준가: 1,000.00 / 청산 기준가: 1,072.64 (+7.26%, 목표 6% 초과 달성)
#   운용 개시 AUM: 237억원
# ───────────────────────────────────────────────────────────────────
...
portfolio_config = {
    ...
    # '목표전환형 2호': {'base_price': 1000.00, 'start_date': '2026-04-29'},  # 2호 완료 (2026-05-06 목표달성, +7.26%)
    # '목표전환형 3차': {'base_price': 1000.00, 'start_date': '2026-04-30'},  # 3차 완료 (2026-05-06 목표달성)
    # '목표전환형': {'base_price': 1000.00, 'start_date': '2026-02-11'},  # 1차 완료 (6% 목표달성)
    # '목표전환형 2차': {'base_price': 1000.00, 'start_date': '2026-03-16'},  # 2차 완료 (2026-04-15 목표달성)
    # '목표전환형 1호': {'base_price': 1000.00, 'start_date': '2026-03-25'},  # 완료 (2026-04-15 목표달성)
}
