...
- 기록자: market_crawler, ECOS/FRED/KOFIA/NPS/KRX/KOSIS/일본capex, SMP, SiliconData, 회사채 발행액([[src-corp-bond-issuance]]), 파생·수급([[src-deriv-daily]]), 코스닥 레버리지 ETF AUM([[src-kosdaq-lev-etf-aum]]) 등.
...
- 2026-08-10 **`ETF_AUM` 타입 신설** — 코스닥 레버리지 ETF 순자산총액 합산 1계열(원 단위 정수, 2015-12-17~ 2,608행 백필). 증분 시 최근 10일 upsert.
