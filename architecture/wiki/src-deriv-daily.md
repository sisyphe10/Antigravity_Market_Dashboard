...
runs_on: "vm_macmini"
schedule_kst: "23:30 + 08:10 (kodex 타이머 편승)"
status: "active"
code:
...
**Domain:** 국내 시장 · **Type:** Source · **Runs on:** vm_macmini · **Schedule (KST):** 23:30 + 08:10 (kodex 타이머 편승) · **Status:** active · **Project:** antigravity
...
- ★**아침 08:10 2회차(2026-08-12)**: 13종 중 **레버리지 ETF AUM**만 당일 저녁에 KRX 확정치가 없어 23:30 실행으로는 비었다. kodex 타이머에 08:10 발화를 추가해 최근 7일 창 재조회로 D-1 AUM을 채운다(나머지 12종은 이미 채워져 있어 멱등 upsert로 무해).
...
## Depends on
- [[timer-kodex-sectors]] — KODEX 섹터 타이머 (23:30 + 08:10, +KOSIS/일본capex/파생 편승)
