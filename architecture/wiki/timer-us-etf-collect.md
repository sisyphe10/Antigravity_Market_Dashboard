...
name: "미국 ETF NAV·AUM 수집 타이머 (us-etf-collect 화~토 08:30)"
domain: "market-global"
project: "antigravity"
type: "timer"
runs_on: "vm_macmini"
schedule_kst: "08:30 화~토"
status: "active"
code:
...
# 미국 ETF NAV·AUM 수집 타이머 (us-etf-collect 화~토 08:30)

**Domain:** 해외 · 매크로 · **Type:** Timer · **Runs on:** vm_macmini · **Schedule (KST):** 08:30 화~토 · **Status:** active · **Project:** antigravity
...
- 홍콩 2종(.HK)은 yfinance NAV가 stale이라 가격(HKD)·AUM(USD)만 수집. 08:30 화~토 = 미국 마감·NAV 확정 후이자 KRX 개장 전.
