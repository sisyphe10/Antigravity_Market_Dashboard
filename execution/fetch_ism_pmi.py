...
SERIES = [
    dict(eid=173,  name='미 ISM 제조업지수',        lo=20, hi=80,
         anchors={'2008-12-31': 32.9, '2020-04-30': 41.5, '2021-03-31': 64.7}),
    dict(eid=1483, name='미 ISM 제조업 신규주문',   lo=15, hi=85,
         anchors={'2008-12-31': 23.2, '2021-03-31': 68.0}),
    dict(eid=1046, name='미 ISM 제조업 고용',       lo=15, hi=85,
         anchors={'2020-04-30': 27.5, '2021-03-31': 59.6}),
    dict(eid=174,  name='미 ISM 제조업 가격',       lo=10, hi=100,
         anchors={'2008-12-31': 18.0, '2021-03-31': 85.6, '2026-06-30': 73.0}),
    dict(eid=176,  name='미 ISM 서비스업지수',      lo=25, hi=80,
         anchors={'2020-04-30': 41.8, '2021-03-31': 63.7, '2026-06-30': 54.0}),
    dict(eid=1484, name='미 ISM 서비스업 기업활동', lo=20, hi=85,
         anchors={'2020-04-30': 26.0, '2021-03-31': 69.4}),
    dict(eid=1050, name='미 ISM 서비스업 신규주문', lo=20, hi=85,
         anchors={'2020-04-30': 32.9, '2021-03-31': 67.2}),
    dict(eid=1049, name='미 ISM 서비스업 가격',     lo=25, hi=95,
