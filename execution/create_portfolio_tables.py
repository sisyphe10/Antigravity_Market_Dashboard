...
PORTFOLIO_DISPLAY_NAMES = {
    ...
    '개방형 랩': 'DB 개방형',
    # '목표전환형 2호': 'NH 목표전환형 2호',  # 2호 완료 (2026-05-06 목표달성, +7.26%)
    # '목표전환형 3차': 'DB 목표전환형 3차',  # 3차 완료 (2026-05-06 목표달성, +7.97%)
    # '목표전환형': 'DB 목표전환형',  # 1차 완료 (6% 목표달성, 2026-02-25 청산)
    # '목표전환형 2차': 'DB 목표전환형 2차 / NH 목표전환형 1호',  # 2차+1호 완료 (2026-04-15 목표달성)
}

# 표시 제외 포트폴리오 (역사 데이터는 보존하되 대시보드에서 숨김)
EXCLUDED_PORTFOLIOS = {'목표전환형', '목표전환형 1호', '목표전환형 2호', '목표전환형 2차', '목표전환형 3차'}
...
def create_portfolio_tables():
    ...
    try:
        ...
        PORTFOLIO_GROUPS = [
            ...
            # {
            #     'sources': ['목표전환형 2호'],  # NH 2호 청산(2026-05-06, +7.26%) — DB 3차도 동일자 청산
            #     'combined': 'NH 목표전환형 2호',
            #     'use': '목표전환형 2호',
            # },
        ]
