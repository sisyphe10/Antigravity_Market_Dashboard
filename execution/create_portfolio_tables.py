...
PORTFOLIO_DISPLAY_NAMES = {
    ...
    '개방형 랩': 'DB 개방형',
    '목표전환형 5차': 'DB 목표전환형 5차',  # 운용 개시 2026-06-12 (NH 4호 2026-06-15 페어 예정)
...
EXCLUDED_PORTFOLIOS = {'목표전환형', '목표전환형 1호', '목표전환형 2호', '목표전환형 2차', '목표전환형 3차', '목표전환형 3호', '목표전환형 4차'}
...
def create_portfolio_tables():
    ...
    try:
        ...
        PORTFOLIO_GROUPS = [
            ...
            {
                # NH 4호(운용개시 2026-06-15) + DB 5차(2026-06-12) 페어. 동일 구성 페어이며
                # 4호는 NEW 시트에 종목 미입력(AUM만 206억) → 5차 보유종목을 공유 표시.
