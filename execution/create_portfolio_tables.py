...
PORTFOLIO_DISPLAY_NAMES = {
    ...
    '개방형 랩': 'DB 개방형',
    '목표전환형 3호': 'NH 목표전환형 3호',  # NH 3호 운용 개시 (2026-05-14, 240억원)
    '목표전환형 4차': 'DB 목표전환형 4차',  # DB 4차 운용 개시 (2026-05-18, AUM 추후 입력)
...
def create_portfolio_tables():
    ...
    try:
        ...
        PORTFOLIO_GROUPS = [
            ...
            {
                'sources': ['목표전환형 3호', '목표전환형 4차'],  # NH 3호 (2026-05-14) + DB 4차 (2026-05-18) 페어
