...
35종: 일별 금리 6 + 파생 2 (ECOS_RATE), 월별 매크로 15 (ECOS_MACRO),
...
SERIES = [
    ...
    dict(name='전산업생산 전년동월비', stat='901Y033', cycle='M', items=('A00',),    dtype='ECOS_MACRO', backfill='202101', transform='yoy', nd=2),  # 농림어업 제외
