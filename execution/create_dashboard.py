...
function renderSector() {
    ...
    filtered.forEach(function(r) {
        ...
        stocksBySec[sec].push({name:r[4]||'',ticker:r[3]||'',mcap:mcapStr,mcapVal:mcapVal,
    ...
    secs.forEach(function(sec,idx) {
        ...
        stocks.forEach(function(s) {
            ...
            html += '<tr class="sec-detail sec-'+idx+'" style="display:none;background:#f3f0ff;font-size:0.85em">';
            html += '<td style="padding-left:24px">'+s.name+'</td><td>'+tk+'</td>';
