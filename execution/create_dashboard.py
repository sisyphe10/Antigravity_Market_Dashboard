...
<head>
    ...
    <style>
        * {{ box-sizing: border-box; margin: 0; padding: 0; }}
        ...
        @keyframes lh-roll {{
            0%   {{ transform: perspective(220px) rotateX(0deg)   rotateY(0deg)   translateY(0)     scale(1); }}
            25%  {{ transform: perspective(220px) rotateX(180deg) rotateY(90deg)  translateY(-16px) scale(1.18); }}
            50%  {{ transform: perspective(220px) rotateX(360deg) rotateY(200deg) translateY(-22px) scale(1.22); }}
            75%  {{ transform: perspective(220px) rotateX(540deg) rotateY(340deg) translateY(-8px)  scale(1.08); }}
            90%  {{ transform: perspective(220px) rotateX(660deg) rotateY(440deg) translateY(2px)   scale(0.95); }}
            100% {{ transform: perspective(220px) rotateX(720deg) rotateY(540deg) translateY(0)     scale(1); }}
        }}
