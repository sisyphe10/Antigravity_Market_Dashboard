...
.sidebar { position: fixed; top: 72px; left: 0; bottom: 0; width: 200px; padding: 90px 10px 18px 10px; background: #fff; border-right: 1px solid #e5e7eb; overflow-y: auto; z-index: 90; box-sizing: border-box; }  /* padding-top 90 = 배지 72 + 간격 18 (top:72 이동분 보정) */
