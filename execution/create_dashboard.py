...
function refresh() {{
    ...
    turnList.forEach(function(r, i) {{
        ...
        h2 += '<tr><td class="c">' + (i+1) + '</td><td class="c">' + r.name + '</td><td class="c">' + r.market + '</td><td class="c">' + avgTurnover.toFixed(1) + '%</td><td class="c">' + fmtVal(r.trdval) + '</td><td class="c ' + cls + '">' + chgLabel + '</td></tr>';
    }});
