...
def create_order_section():
    ...
    return """
        ...
        function buildOrderNateonText(stocks, st, headerLabel) {
            ...
            if (newBuy.length) lines.push('신규매수: ' + fmtList(newBuy));
        ...
        function renderOrderPanel(pfName) {
            ...
            stocks.forEach(function(s, i) {
                ...
                // portfolio_data.json 출처 종목은 변경후=0(전량매도)으로 표현하므로 행 삭제 불필요.
...
<head>
    ...
    <style>
        * {{ box-sizing: border-box; margin: 0; padding: 0; }}
        ...
        .lh-spark {{ flex: 0 0 auto; width: 202px; height: 80px; padding: 0 10px; border-left: 1px solid #d4d4d4; border-right: 1px solid #d4d4d4; display: flex; align-items: center; justify-content: center; }}
        ...
        .lh-shuffle {{ flex: 0 0 auto; background: none; border: none; cursor: pointer; font-size: 2.1rem; opacity: 0.35; padding: 8px 12px; transition: opacity 0.15s, transform 0.2s; line-height: 1; color: inherit; }}
