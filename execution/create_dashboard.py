...
function renderSector() {
    ...
    secs.forEach(function(sec,idx) {
        ...
        stocks.forEach(function(s) {
            ...
            html += '<td style="background:#f3f0ff">'+sc(s.ytd)+'</td><td>'+sc(s.d1)+'</td><td>'+sc(s.w1)+'</td><td>'+sc(s.m1)+'</td><td>'+sc(s.m3)+'</td><td>'+sc(s.m6)+'</td><td>'+sc(s.y1)+'</td><td style="background:#fff8e1">'+sc(s.rsi)+'</td>';
            html += '</tr>';
        });
    });
    html += '</tbody></table>';
