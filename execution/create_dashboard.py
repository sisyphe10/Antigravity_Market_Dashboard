...
.topnav-tab { padding: 10px 24px; display: inline-flex; align-items: center; gap: 6px; color: #444; text-decoration: none; font-size: 1rem; font-weight: 600; border: 1.5px solid #d1d5db; border-radius: 999px; white-space: nowrap; background: #fff; transition: all 0.15s; font-family: PRETENDARD_STACK_PLACEHOLDER; cursor: pointer; }
...
.sidebar { position: fixed; top: 0; left: 0; bottom: 0; width: 200px; padding: 104px 10px 18px 10px; background: #fff; border-right: 1px solid #e5e7eb; overflow-y: auto; z-index: 150; box-sizing: border-box; }
