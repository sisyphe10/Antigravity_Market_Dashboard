...
.skill-table th { background: #1a1b1e; border: 1px solid #2a2b2e; padding: 6px 10px;
                  font-size: 13px; font-weight: 700; color: #fb8b1e; text-align: center; white-space: nowrap; }
.skill-table td { border: 1px solid #222326; padding: 7px 10px; color: #d9dde2; vertical-align: middle;
                  font-size: 15px; }
