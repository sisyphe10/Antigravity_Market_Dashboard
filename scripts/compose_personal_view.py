...
AOE_DARK_CSS = (
    ...
    '.cmb-series-row:has(.cmb-chart-item.active) ~ .cmb-series-row:has(.cmb-chart-item.active) ~ .cmb-series-row:has(.cmb-chart-item.active) td{background:#4a2d0a!important;color:#ffb45e!important;font-weight:700!important}'
