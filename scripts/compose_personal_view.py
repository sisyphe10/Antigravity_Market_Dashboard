...
AOE_DARK_CSS = (
    ...
    '#cmbStartDate,#cmbEndDate,#idxStartDate,#idxEndDate{color:#fff!important}'
    ...
    'font-weight:700}'
    # DATA ★ 퀵필터 (2026-08-22 개편): 안 누름=색 테두리+색 별(빈 배경), 누름=색 채움 — 일괄 pill 규칙보다 뒤라 우선.
    '.cmb-quick-btn[data-qv="star"]{background:' + P['input-bg'] + '!important;color:' + P['hl2-fg'] + '!important;border-color:' + P['hl2-fg'] + '!important}'
    '.cmb-quick-btn[data-qv="upd"]{background:' + P['input-bg'] + '!important;color:' + P['hl3-fg'] + '!important;border-color:' + P['hl3-fg'] + '!important}'
    '.cmb-quick-btn[data-qv="star"].active{background:' + P['hl2-fg'] + '!important;color:' + P['hl2-bg'] + '!important;border-color:' + P['hl2-fg'] + '!important;font-weight:700}'
    '.cmb-quick-btn[data-qv="upd"].active{background:' + P['hl3-fg'] + '!important;color:' + P['hl3-bg'] + '!important;border-color:' + P['hl3-fg'] + '!important;font-weight:700}'
