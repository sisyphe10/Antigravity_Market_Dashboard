...
AOE_DARK_CSS = (
    ...
    '.sidebar,.ledger-subtabs,.mm-main .subtabs{height:39px!important;'
    'box-sizing:border-box!important;align-items:stretch!important;overflow:hidden!important}'
    '.sidebar-link,.ledger-subtab,.mm-main .subtabs .subtab{height:38px!important}'
    ...
    '.ledger-subtabs{margin:-36px calc(50% - 50vw) 18px!important}'
