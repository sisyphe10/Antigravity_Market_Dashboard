...
AOE_DARK_CSS = (
    ...
    '[style*="background:#fff"][style*="color:#"],[style*="background: #fff"][style*="color:#"],[style*="background:#f9fafb"][style*="color:#"],[style*="background:#f3f4f6"][style*="color:#"],[style*="background:#fafafa"][style*="color:#"]{color:#333!important}'
    '</style>')
